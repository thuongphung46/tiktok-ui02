    ...
    <>
      <div className={cs('overflow-auto')} style={{ flex: '1 1 0%' }}>
        <div className={cs('wrapper-menu-level2')} /*"m-auto w-4/5"*/>
          <h3 className={cs('text-center')} /*"text-center text-2xl md:text-3xl lg:text-4xl font-bold my-4 mx-auto"*/>
            Log in
          </h3>
          ...
          <form onSubmit={loginUser}>
            ...
            <Button
              primary
              outline
              className="mt-8 border-none text-base leading-5 font-bold font-primary rounded flex w-full cursor-pointer py-1.5 px-2"
              style={{
                minWidth: '120px',
                minHeight: '46px',
